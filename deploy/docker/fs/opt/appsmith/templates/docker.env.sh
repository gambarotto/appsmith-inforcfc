...
# Disable self-service signup by default (instance owner manages invites)
...
APPSMITH_DB_URL=mongodb://appsmith:S3nh@Fort3!@appsmith-mongo:27017/appsmith
...
APPSMITH_ENCRYPTION_PASSWORD=t7YpWQmP6J4sR9nLz3V2aXhC1eG8uK5d
APPSMITH_ENCRYPTION_SALT=Q8rS1vN6yB3wF0pL5tZ2kD7hX4gJ9cM1
EOF
